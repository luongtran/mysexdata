...
json.(@current_user, :name, :email, :facebook_id, :status, :main_photo_url, :photo_num, :job, :age, :startday, :eye_color, :hair_color, :height, :hairdressing, :sex_interest, :sex_gender, :preferences)
